...
- (void)reloadPermissionData {
    ...
    model.type = EMGroupInfoPermissionType_groupId;
    ...
    model.type = EMGroupInfoPermissionType_groupType;
    [sectionData1 addObject:model];
    ...
    if (isOwner) {
        ...
        model.isEdit = NO;
        model.type = isPublic ? EMGroupInfoPermissionType_openJoin : EMGroupInfoPermissionType_canAllInvite;
        ...
        model.isEdit = YES;
        model.type = EMGroupInfoPermissionType_mute;
    ...
    if (!isOwner && !_currentGroup.isBlocked) {
        ...
        model.isEdit = YES;
        model.type = EMGroupInfoPermissionType_pushSetting;
...
- (void)permissionSelectAction:(UISwitch *)permissionSwitch {
    if (permissionSwitch.tag == EMGroupInfoPermissionType_mute) {
    ...
    else if (permissionSwitch.tag == EMGroupInfoPermissionType_pushSetting) {
